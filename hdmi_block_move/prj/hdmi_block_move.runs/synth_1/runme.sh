...
HD_PWD='C:/Users/Admin/Desktop/wang/7020/14_hdmi_block_move/prj/hdmi_block_move.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hdmi_block_move.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_hdmi_block_move.tcl
