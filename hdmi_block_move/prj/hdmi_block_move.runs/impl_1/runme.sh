...
HD_PWD='C:/Users/Admin/Desktop/wang/7020/14_hdmi_block_move/prj/hdmi_block_move.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_hdmi_block_move.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_hdmi_block_move.tcl -notrace
